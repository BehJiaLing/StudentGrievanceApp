...
public class StatusNotificationActivity extends AppCompatActivity {
    ...
    private String grievanceStatusFromId, grievanceRefreshStatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("StatusNotificationActivity", "Grievance Document ID is: " + documentId);
        ...
        String grievanceDateTime = intent.getStringExtra("grievance_updatedTime");
        ...
        statusUpdateButton.setVisibility(View.GONE);  // Initially hide the button
            ...
            db.collection("grievance").document(documentId)
                    ...
                    .addOnSuccessListener(documentSnapshot -> {
                        if (documentSnapshot.exists()) {
                            grievanceStatusFromId = documentSnapshot.getString("status");

                            if (grievanceStatusFromId != null) {
                                setStatusIndicators(grievanceStatusFromId);
                                if ("Resolved".equalsIgnoreCase(grievanceStatusFromId)) {
                                ...
                                Log.e("StatusNotificationActivity", "Grievance status is null");
                            }

                        } else {
                            Log.e("StatusNotificationActivity", "Document not found");
                        }
                    })
                    .addOnFailureListener(e -> Log.e("StatusNotificationActivity", "Failed to fetch status: " + e.getMessage()));
        }
    }
    ...
    private void setStatusIndicators(String status) {
        ...
        // Check if status is null to prevent NullPointerException
        if (status == null) {
            Log.e("StatusNotificationActivity", "Status is null, unable to set indicators.");
    ...
    private void updateGrievanceStatusInDb(String documentId) {
        Log.e("StatusNotificationActivity", "Update ID is: " + documentId);
        progressDialog.show();
